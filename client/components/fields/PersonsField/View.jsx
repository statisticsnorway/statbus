...
import { getNewName, getNewPersonName } from 'helpers/locale'
...
class PersonView extends React.Component {
  ...
  render() {
    ...
    const role = hasValue(roles) && roles.filter(x => x.personId === data.id)
    return (
      <Table.Row>
        ...
        <Table.Cell content={role && getNewPersonName(role)} textAlign="center" />
