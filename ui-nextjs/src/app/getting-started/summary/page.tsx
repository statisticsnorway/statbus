  ...
  return (
    <div className="text-center space-y-6">
      ...
      <p>
        ...
        Statbus to use the <strong>{settings?.[0].activity_category_standard.name}</strong> activity category standard and you
        have uploaded <strong>{regions?.length ?? 0}</strong> regions.
      </p>
