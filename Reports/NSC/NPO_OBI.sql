...
----NPO_OBI, PIVOT IS NEEDED

Select Coalesce(reg.Name, 'Кыргызская Республика') Region, Count(RegId) qty, l.Name
From (
...
Where CodeLegF >= 51 and CodeLegF <= 58
) t 
Join Regions reg on reg.Id = t.Region
Join LegalForms l on l.Code = t.CodeLegF 
Group by reg.Name, l.Name with cube
