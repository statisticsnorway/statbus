...
-----EGRSE BRANCHES, SUBUNITS; PIVOT IS NEEDED
...
From (
	...
	Cross Apply
	(Select ChildId as Region From RegionsFinal Where (Level = 2 and a.Parents Like '%.' + Convert(varchar(6), ChildId) + '.%') or (Level = 2 and LEN(Convert(varchar(6), a.Parents)) = 1)) t1 WHERE LForm = 'SublegalUnit'
) t 
