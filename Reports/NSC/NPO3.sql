...
---NPO3, PIVOT IS NEEDED

Select Coalesce(reg.Name, 'Кыргызская Республика') Region, Coalesce(a.Name, 'Total') as Name, Count(RegId) qty 
From (
...
Join ActivityCategories a on a.Code = t.ActCode Where Left(ActCode,2) = '94'
