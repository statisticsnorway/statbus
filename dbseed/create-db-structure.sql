...
CREATE TABLE public.history (
    ...
    reorg_type_id integer,
    unit_status_id integer,
    CONSTRAINT "One and only one of local_unit_id legal_unit_id enterprise_unit_id must be set"
    CHECK( local_unit_id IS NOT NULL AND legal_unit_id IS     NULL AND enterprise_unit_id IS     NULL AND enterprise_group_id IS     NULL
        OR local_unit_id IS     NULL AND legal_unit_id IS NOT NULL AND enterprise_unit_id IS     NULL AND enterprise_group_id IS     NULL
        OR local_unit_id IS     NULL AND legal_unit_id IS     NULL AND enterprise_unit_id IS NOT NULL AND enterprise_group_id IS     NULL
        OR local_unit_id IS     NULL AND legal_unit_id IS     NULL AND enterprise_unit_id IS     NULL AND enterprise_group_id IS NOT NULL
        )
);
...
CREATE TABLE public.activity_for_unit (
    ...
    local_unit_id integer REFERENCES public.local_unit(id) ON DELETE CASCADE,
    legal_unit_id integer REFERENCES public.legal_unit(id) ON DELETE CASCADE,
    enterprise_unit_id integer REFERENCES public.enterprise_unit(id) ON DELETE CASCADE,
...
--
-- Name: enterprise_unit_id_seq; Type: SEQUENCE SET; Schema: public; Owner: statbus_development
--

SELECT pg_catalog.setval('public.enterprise_unit_id_seq', 1, false);
...
--
-- Name: local_unit_id_seq; Type: SEQUENCE SET; Schema: public; Owner: statbus_development
--

SELECT pg_catalog.setval('public.local_unit_id_seq', 1, false);
...
--
-- Name: ix_activity_for_unit_enterprise_unit_id; Type: INDEX; Schema: public; Owner: statbus_development
--

CREATE INDEX ix_activity_for_unit_enterprise_unit_id ON public.activity_for_unit USING btree (enterprise_unit_id);


--
-- Name: ix_activity_for_unit_local_unit_id; Type: INDEX; Schema: public; Owner: statbus_development
--

CREATE INDEX ix_activity_for_unit_local_unit_id ON public.activity_for_unit USING btree (local_unit_id);
...
CREATE INDEX ix_analysis_log_analysis_queue_id_local_unit_id ON public.analysis_log USING btree (local_unit_id);
CREATE INDEX ix_analysis_log_analysis_queue_id_legal_unit_id ON public.analysis_log USING btree (legal_unit_id);
CREATE INDEX ix_analysis_log_analysis_queue_id_enterprise_unit_id ON public.analysis_log USING btree (enterprise_unit_id);
...
--
-- Name: ix_enterprise_unit_short_name_reg_ident_stat_ident_tax_reg_ident; Type: INDEX; Schema: public; Owner: statbus_development
--

CREATE INDEX ix_enterprise_unit_short_name_reg_ident_stat_ident_tax_reg_ident ON public.enterprise_unit USING btree (short_name, reg_ident, stat_ident, tax_reg_ident);
...
--
-- Name: ix_enterprise_unit_stat_ident; Type: INDEX; Schema: public; Owner: statbus_development
--

CREATE INDEX ix_enterprise_unit_stat_ident ON public.enterprise_unit USING btree (stat_ident);
...
--
-- Name: ix_legal_unit_enterprise_unit_id; Type: INDEX; Schema: public; Owner: statbus_development
--

CREATE INDEX ix_legal_unit_enterprise_unit_id ON public.legal_unit USING btree (enterprise_unit_id);
...
--
-- Name: ix_local_unit_short_name_reg_ident_stat_ident_tax_reg_ident; Type: INDEX; Schema: public; Owner: statbus_development
--

CREATE INDEX ix_local_unit_short_name_reg_ident_stat_ident_tax_reg_ident ON public.local_unit USING btree (short_name, reg_ident, stat_ident, tax_reg_ident);
...
--
-- Name: ix_local_unit_stat_ident; Type: INDEX; Schema: public; Owner: statbus_development
--

CREATE INDEX ix_local_unit_stat_ident ON public.local_unit USING btree (stat_ident);
...
--
-- Name: activity_for_unit fk_activity_for_unit_enterprise_unit_enterprise_unit_temp_id3; Type: FK CONSTRAINT; Schema: public; Owner: statbus_development
--

ALTER TABLE ONLY public.activity_for_unit
    ADD CONSTRAINT fk_activity_for_unit_enterprise_unit_enterprise_unit_temp_id3 FOREIGN KEY (enterprise_unit_id) REFERENCES public.enterprise_unit(id);
...
ALTER TABLE ONLY public.enterprise_unit
    ADD CONSTRAINT fk_enterprise_unit_enterprise_group_enterprise_group_id FOREIGN KEY (enterprise_group_id) REFERENCES public.enterprise_group(id);
...
ALTER TABLE ONLY public.legal_unit
    ADD CONSTRAINT fk_legal_unit_enterprise_unit_enterprise_unit_temp_id FOREIGN KEY (enterprise_unit_id) REFERENCES public.enterprise_unit(id);
...
ALTER TABLE ONLY public.local_unit
    ADD CONSTRAINT fk_local_unit_legal_unit_legal_unit_id FOREIGN KEY (legal_unit_id) REFERENCES public.legal_unit(id);
...
ALTER TABLE ONLY public.person_for_unit
    ADD CONSTRAINT fk_person_for_unit_enterprise_unit_enterprise_unit_id FOREIGN KEY (enterprise_unit_id) REFERENCES public.enterprise_unit(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.person_for_unit
    ADD CONSTRAINT fk_person_for_unit_local_unit_local_unit_id FOREIGN KEY (local_unit_id) REFERENCES public.local_unit(id) ON DELETE CASCADE;
