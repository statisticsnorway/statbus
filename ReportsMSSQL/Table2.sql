...
---Table2
Select Coalesce(Name, 'Total'), isnull(SizeGrp,'Total'), Total, ActTotal, Legal, ActLegal, prev as '2016', curr as '2017' 
	From(
		Select Left(Sect,1) as Sect, SizeGrp, 
		Case SizeGrp
		When 'Small' Then 1
		When 'Medium' Then 2
		When 'Big' Then 3
		...
		From ActualStatFinal group by Left(Sect,1), SizeGrp With Cube
	) x 
