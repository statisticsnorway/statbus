...
Select Coalesce(PropGrp, 'Total'), isnull(SizeGrp,'Total'), Total, ActTotal, Legal, ActLegal, prev as '2016', curr as '2017' From 
	(
		Select PropGrp, SizeGrp, 
		Case SizeGrp
		When 'Small' Then 1
		When 'Medium' Then 2
		When 'Big' Then 3
		...
		From ActualStatFinal group by PropGrp, SizeGrp With Cube
	) x Order by PropGrp, r