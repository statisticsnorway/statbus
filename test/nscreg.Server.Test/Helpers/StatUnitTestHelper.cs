...
namespace nscreg.Server.Test
{
    public class StatUnitTestHelper
    {
        ...
        {
            //await new CreateService(context, _analysisRules, _mandatoryFields, _validationSettings, _mapper, shouldAnalyze: false).CreateLegalUnit(new LegalUnitCreateM
            //{
        ...
        {
            //await new CreateService(context, _analysisRules, _mandatoryFields, _validationSettings, _mapper, shouldAnalyze: false).CreateLocalUnit(new LocalUnitCreateM
            //{
        ...
        {
            //await new CreateService(context, _analysisRules, _mandatoryFields, _validationSettings, _mapper, shouldAnalyze: false).CreateEnterpriseUnit(new EnterpriseUnitCreateM
            //{
        ...
        {
            //await new CreateService(context, _analysisRules, _mandatoryFields, _validationSettings, _mapper, shouldAnalyze: false).CreateEnterpriseGroup(new EnterpriseGroupCreateM
            //{
