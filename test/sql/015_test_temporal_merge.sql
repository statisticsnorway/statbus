...
\echo '--- Planner: Expected Plan ---'
SELECT * FROM (VALUES
    ('{102}'::INT[], 'UPDATE'::import.plan_operation_type, 2, '2023-12-31'::DATE, '2023-12-31'::DATE, '2024-12-31'::DATE, '{"name": "Patched", "employees": 25, "legal_unit_id": 1, "edit_comment": "Starts patch"}'::JSONB, 'starts'::public.allen_interval_relation),
    ('{102}'::INT[], 'INSERT'::import.plan_operation_type, 2, NULL::DATE,         '2024-12-31'::DATE, '2025-12-31'::DATE, '{"name": "Original", "employees": 20, "legal_unit_id": 1, "edit_comment": "Original slice"}'::JSONB, NULL::public.allen_interval_relation)
) AS t (source_row_ids, operation, entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation);
\echo '--- Planner: Actual Plan ---'
SELECT source_row_ids, operation, (entity_ids->>'id')::INT AS entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation FROM import.temporal_merge_plan(
    p_target_schema_name       => :'target_schema',
...
\echo '--- Planner: Expected Plan ---'
SELECT * FROM (VALUES
    ('{103}'::INT[],    'UPDATE'::import.plan_operation_type, 3, '2023-12-31'::DATE, '2023-12-31'::DATE, '2024-12-31'::DATE, '{"name": "Original", "employees": 30, "legal_unit_id": 1}'::JSONB, 'starts'::public.allen_interval_relation),
    ('{103}'::INT[], 'INSERT'::import.plan_operation_type, 3, NULL::DATE, '2024-12-31'::DATE, '2025-12-31'::DATE, '{"name": "Patched", "employees": 35, "legal_unit_id": 1}'::JSONB, NULL::public.allen_interval_relation)
) AS t (source_row_ids, operation, entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation);
\echo '--- Planner: Actual Plan ---'
SELECT source_row_ids, operation, (entity_ids->>'id')::INT AS entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation FROM import.temporal_merge_plan(
    p_target_schema_name       => :'target_schema',
...
\echo '--- Planner: Expected Plan ---'
SELECT * FROM (VALUES
    ('{104}'::INT[], 'UPDATE'::import.plan_operation_type, 4, '2023-12-31'::DATE, '2023-12-31'::DATE, '2024-06-30'::DATE, '{"name": "Original", "employees": 40, "legal_unit_id": 1}'::JSONB, 'starts'::public.allen_interval_relation),
    ('{104}'::INT[], 'INSERT'::import.plan_operation_type, 4, NULL::DATE,         '2024-06-30'::DATE, '2024-12-31'::DATE, '{"name": "Patched", "employees": 45, "legal_unit_id": 1}'::JSONB,  NULL::public.allen_interval_relation),
    ('{104}'::INT[], 'INSERT'::import.plan_operation_type, 4, NULL::DATE,         '2024-12-31'::DATE, '2025-12-31'::DATE, '{"name": "Original", "employees": 40, "legal_unit_id": 1}'::JSONB, NULL::public.allen_interval_relation)
) AS t (source_row_ids, operation, entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation);
\echo '--- Planner: Actual Plan ---'
SELECT source_row_ids, operation, (entity_ids->>'id')::INT AS entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation FROM import.temporal_merge_plan(
    p_target_schema_name       => :'target_schema',
...
\echo '--- Planner: Expected Plan ---'
SELECT * FROM (VALUES
    ('{105}'::INT[], 'UPDATE'::import.plan_operation_type, 5, '2023-12-31'::DATE, '2023-12-31'::DATE, '2024-06-30'::DATE, '{"name": "Original", "employees": 50, "legal_unit_id": 1}'::JSONB, 'starts'::public.allen_interval_relation),
    ('{105}'::INT[], 'INSERT'::import.plan_operation_type, 5, NULL::DATE, '2024-06-30'::DATE, '2025-06-30'::DATE, '{"name": "Patched", "employees": 55, "legal_unit_id": 1}'::JSONB, NULL::public.allen_interval_relation)
) AS t (source_row_ids, operation, entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation);
\echo '--- Planner: Actual Plan ---'
SELECT source_row_ids, operation, (entity_ids->>'id')::INT AS entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation FROM import.temporal_merge_plan(
    p_target_schema_name       => :'target_schema',
...
\echo '--- Planner: Expected Plan ---'
SELECT * FROM (VALUES
    ('{106}'::INT[], 'UPDATE'::import.plan_operation_type, 6, '2024-06-30'::DATE, '2024-12-31'::DATE, '2025-06-30'::DATE, '{"name": "Original", "employees": 60, "legal_unit_id": 1}'::JSONB, 'finishes'::public.allen_interval_relation),
    ('{106}'::INT[], 'INSERT'::import.plan_operation_type, 6, NULL::DATE,         '2023-12-31'::DATE, '2024-12-31'::DATE, '{"name": "Patched", "employees": 65, "legal_unit_id": 1}'::JSONB,   NULL::public.allen_interval_relation)
) AS t (source_row_ids, operation, entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation);
\echo '--- Planner: Actual Plan ---'
SELECT source_row_ids, operation, (entity_ids->>'id')::INT AS entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation FROM import.temporal_merge_plan(
    p_target_schema_name       => :'target_schema',
...
\echo '--- Planner: Expected Plan ---'
SELECT * FROM (VALUES
    ('{107}'::INT[], 'INSERT'::import.plan_operation_type, 7, NULL::DATE, '2023-12-31'::DATE, '2024-12-31'::DATE, '{"name": "Patched", "employees": 75, "legal_unit_id": 1}'::JSONB, NULL::public.allen_interval_relation)
) AS t (source_row_ids, operation, entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation);
\echo '--- Planner: Actual Plan ---'
SELECT source_row_ids, operation, (entity_ids->>'id')::INT AS entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation FROM import.temporal_merge_plan(
    p_target_schema_name       => :'target_schema',
...
\echo '--- Planner: Expected Plan ---'
SELECT * FROM (VALUES
    ('{108}'::INT[], 'INSERT'::import.plan_operation_type, 8, NULL::DATE, '2024-12-31'::DATE, '2025-12-31'::DATE, '{"name": "Patched", "employees": 85, "legal_unit_id": 1}'::JSONB, NULL::public.allen_interval_relation)
) AS t (source_row_ids, operation, entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation);
\echo '--- Planner: Actual Plan ---'
SELECT source_row_ids, operation, (entity_ids->>'id')::INT AS entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation FROM import.temporal_merge_plan(
    p_target_schema_name       => :'target_schema',
...
\echo '--- Planner: Expected Plan ---'
SELECT * FROM (VALUES
    ('{109}'::INT[], 'INSERT'::import.plan_operation_type, 9, NULL::DATE, '2023-12-31'::DATE, '2024-12-31'::DATE, '{"name": "Patched", "employees": 95, "legal_unit_id": 1}'::JSONB, NULL::public.allen_interval_relation)
) AS t (source_row_ids, operation, entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation);
\echo '--- Planner: Actual Plan ---'
SELECT source_row_ids, operation, (entity_ids->>'id')::INT AS entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation FROM import.temporal_merge_plan(
    p_target_schema_name       => :'target_schema',
...
\echo '--- Planner: Expected Plan ---'
SELECT * FROM (VALUES
    ('{110}'::INT[], 'INSERT'::import.plan_operation_type, 10, NULL::DATE, '2025-01-01'::DATE, '2025-12-31'::DATE, '{"name": "Patched", "employees": 105, "legal_unit_id": 1}'::JSONB, NULL::public.allen_interval_relation)
) AS t (source_row_ids, operation, entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation);
\echo '--- Planner: Actual Plan ---'
SELECT source_row_ids, operation, (entity_ids->>'id')::INT AS entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation FROM import.temporal_merge_plan(
    p_target_schema_name       => :'target_schema',
...
\echo '--- Planner: Expected Plan ---'
SELECT * FROM (VALUES
    ('{111}'::INT[], 'UPDATE'::import.plan_operation_type, 11, '2023-12-31'::DATE, '2023-12-31'::DATE, '2024-12-31'::DATE, '{"name": "Patched", "employees": 115, "legal_unit_id": 1}'::JSONB, 'equals'::public.allen_interval_relation)
) AS t (source_row_ids, operation, entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation);
\echo '--- Planner: Actual Plan ---'
SELECT source_row_ids, operation, (entity_ids->>'id')::INT AS entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation FROM import.temporal_merge_plan(
    p_target_schema_name       => :'target_schema',
...
SELECT * FROM (VALUES
    ('{401, 402}'::INT[], 'INSERT'::import.plan_operation_type, 4, NULL::DATE, '2023-01-01'::DATE, '2023-12-31'::DATE, '{"name": "Continuous Op", "employees": 20, "legal_unit_id": 1}'::JSONB, NULL::public.allen_interval_relation)
) AS t (source_row_ids, operation, entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation);
\echo '--- Planner: Actual Plan ---'
SELECT source_row_ids, operation, (entity_ids->>'id')::INT AS entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation FROM import.temporal_merge_plan(
    p_target_schema_name       => :'target_schema',
...
\echo '--- Planner: Expected Plan (A single INSERT for the full period) ---'
SELECT * FROM (VALUES
    ('{501, 502, 503}'::INT[], 'INSERT'::import.plan_operation_type, 5, NULL::DATE, '2023-01-01'::DATE, '2023-09-30'::DATE, '{"name": "Three-part Op", "employees": 30, "legal_unit_id": 1}'::JSONB, NULL::public.allen_interval_relation)
) AS t (source_row_ids, operation, entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation);
\echo '--- Planner: Actual Plan ---'
SELECT source_row_ids, operation, (entity_ids->>'id')::INT AS entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation FROM import.temporal_merge_plan(
    p_target_schema_name       => :'target_schema',
...
SELECT * FROM (VALUES
    ('{601}'::INT[], 'INSERT'::import.plan_operation_type, 6, NULL::DATE, '2023-01-01'::DATE, '2023-06-30'::DATE, '{"name": "First Part", "employees": 40, "legal_unit_id": 1}'::JSONB, NULL::public.allen_interval_relation),
    ('{602}'::INT[], 'INSERT'::import.plan_operation_type, 6, NULL::DATE, '2023-06-30'::DATE, '2023-12-31'::DATE, '{"name": "Second Part", "employees": 50, "legal_unit_id": 1}'::JSONB, NULL::public.allen_interval_relation)
) AS t (source_row_ids, operation, entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation);
\echo '--- Planner: Actual Plan ---'
SELECT source_row_ids, operation, (entity_ids->>'id')::INT AS entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation FROM import.temporal_merge_plan(
    p_target_schema_name       => :'target_schema',
...
SELECT * FROM (VALUES
    ('{701}'::INT[], 'UPDATE'::import.plan_operation_type, 7, '2022-12-31'::DATE, '2022-12-31'::DATE, '2023-12-31'::DATE, '{"name": "Existing Op", "employees": 60, "legal_unit_id": 1}'::JSONB, 'started_by'::public.allen_interval_relation)
) AS t (source_row_ids, operation, entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation);
\echo '--- Planner: Actual Plan ---'
SELECT source_row_ids, operation, (entity_ids->>'id')::INT AS entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation FROM import.temporal_merge_plan(
    p_target_schema_name       => :'target_schema',
...
SELECT * FROM (VALUES
    ('{801}'::INT[], 'INSERT'::import.plan_operation_type, 40, NULL::DATE, '2023-12-31'::DATE, '2024-12-31'::DATE, '{"name": "Default Test", "employees": 10, "edit_comment": "Default Insert", "legal_unit_id": 1}'::JSONB, NULL::public.allen_interval_relation)
) AS t (source_row_ids, operation, entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation);
\echo '--- Planner: Actual Plan ---'
SELECT source_row_ids, operation, (entity_ids->>'id')::INT AS entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation FROM import.temporal_merge_plan(
    p_target_schema_name       => :'target_schema',
    ...
    p_source_row_ids           => NULL,
    p_ephemeral_columns        => :'ephemeral_cols'::TEXT[],
    p_insert_defaulted_columns => ARRAY['created_at']
);
