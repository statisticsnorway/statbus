...
CALL set_test_replace.reset_target();
INSERT INTO set_test_replace.legal_unit VALUES (1, '2023-12-31', '2024-12-31', 'Old Name');
...
CALL set_test_replace.reset_target();
INSERT INTO set_test_replace.legal_unit VALUES (1, '2023-12-31', '2024-12-31', 'Original Name');
CREATE TEMP TABLE temp_source (LIKE temp_source) ON COMMIT DROP;
...
CALL set_test_replace.reset_target();
INSERT INTO set_test_replace.legal_unit VALUES (1, '2024-03-31', '2024-08-31', 'Old Name');
CREATE TEMP TABLE temp_source (LIKE temp_source) ON COMMIT DROP;
...
CALL set_test_replace.reset_target();
INSERT INTO set_test_replace.legal_unit VALUES (1, '2023-12-31', '2024-12-31', 'Original Full Year');
CREATE TEMP TABLE temp_source (LIKE temp_source) ON COMMIT DROP;
