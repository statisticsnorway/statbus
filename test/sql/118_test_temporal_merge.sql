...
SELECT source_row_ids, operation, (entity_ids->>'id')::INT AS entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation FROM import.temporal_merge_plan(:'target_schema', :'target_table', :'source_schema', 'temp_source_1', :'entity_id_cols'::TEXT[], NULL, :'ephemeral_cols'::TEXT[], '{}'::TEXT[], 'upsert_patch');
...
SELECT source_row_id, target_entity_ids, status, error_message FROM import.temporal_merge(:'target_schema', :'target_table', :'source_schema', 'temp_source_1', :'entity_id_cols'::TEXT[], NULL, :'ephemeral_cols'::TEXT[], '{}'::TEXT[], 'upsert_patch');
...
CREATE TEMP TABLE temp_source_18 (
    row_id INT, id INT, valid_after DATE NOT NULL, valid_to DATE NOT NULL, name TEXT, edit_comment TEXT, employees INT
) ON COMMIT DROP;
INSERT INTO temp_source_18 VALUES (102, 1, '2023-12-31', '2024-12-31', NULL, 'Replaced with NULL', NULL);

\echo '--- Planner: Expected Plan ---'
SELECT * FROM (VALUES
    ('{102}'::INT[], 'UPDATE'::import.plan_operation_type, 1, '2023-12-31'::DATE, '2023-12-31'::DATE, '2024-12-31'::DATE, '{"name": null, "employees": null}'::JSONB, 'equals'::public.allen_interval_relation)
) AS t (source_row_ids, operation, entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation);
\echo '--- Planner: Actual Plan ---'
SELECT source_row_ids, operation, (entity_ids->>'id')::INT AS entity_id, old_valid_after, new_valid_after, new_valid_to, data, relation FROM import.temporal_merge_plan(:'target_schema', :'target_table', :'source_schema', 'temp_source_18', :'entity_id_cols'::TEXT[], NULL, :'ephemeral_cols'::TEXT[], '{}'::TEXT[], 'upsert_replace');
...
\echo '--- Orchestrator: Actual Feedback ---'
SELECT source_row_id, target_entity_ids, status, error_message FROM import.temporal_merge(:'target_schema', :'target_table', :'source_schema', 'temp_source_18', :'entity_id_cols'::TEXT[], NULL, :'ephemeral_cols'::TEXT[], '{}'::TEXT[], 'upsert_replace');
...
\echo '--- Orchestrator: Actual Feedback ---'
SELECT source_row_id, target_entity_ids, status, error_message FROM import.temporal_merge(:'target_schema', :'target_table', :'source_schema', 'temp_source_35', :'entity_id_cols'::TEXT[], NULL, :'ephemeral_cols'::TEXT[], '{}'::TEXT[], 'patch_only');
...
SELECT source_row_id, target_entity_ids, status, error_message FROM import.temporal_merge(:'target_schema', :'target_table', :'source_schema', 'temp_source_35', :'entity_id_cols'::TEXT[], NULL, :'ephemeral_cols'::TEXT[], '{}'::TEXT[], 'upsert_patch');
