...
-- Test 11: Session Context Management
\echo '=== Test 11: Session Context Management ==='
DO $$
DECLARE
...
BEGIN
    ...
    RAISE NOTICE 'Test 11: Session Context Management - PASSED';
END;
$$;
...
\echo 'All auth tests completed successfully! (12 tests)'
