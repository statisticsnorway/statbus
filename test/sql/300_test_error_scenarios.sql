...
SAVEPOINT scenario_70_1_warnings;
...
('700100028','LU Invalid PostalRegion','2023-01-01','2023-12-31','2100','AS','01.110','2023-01-01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'active',NULL,NULL,NULL,'POSTAL_XX',NULL), -- warnings: {postal_region_code}
('700100029','LU Invalid PostalCountry NF','2023-01-01','2023-12-31','2100','AS','01.110','2023-01-01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'active',NULL,NULL,NULL,NULL,'P_ZZ'), -- warnings: {postal_country_iso_2}
-- Country/region validation
('700100030','LU domestic missing region warning','2023-01-01','2023-12-31','2100','AS','01.110','2023-01-01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'NO',NULL,'active',NULL,NULL,NULL,NULL,NULL), -- warnings: {physical_region_code: NULL}
...
('700100032','LU foreign domestic region err','2023-01-01','2023-12-31','2100','AS','01.110','2023-01-01',NULL,NULL,NULL,NULL,NULL,'Street 1','01','UN',NULL,'active',NULL,NULL,NULL,NULL,NULL), -- warnings: {physical_region_code: 01}
('700100033','LU foreign unknown domestic region error','2023-01-01','2023-12-31','2100','AS','01.110','2023-01-01',NULL,NULL,NULL,NULL,NULL,'Street 1','ZZ','UN',NULL,'active',NULL,NULL,NULL,NULL,NULL); -- warnings: {physical_region_code: ZZ}
...
\echo "Data table for import_70_01_01_lu_analysis_errors (expect various errors and warnings):"
SELECT
    row_id,
    name_raw as name,
    state,
...
SELECT row_id, name_raw as name, state, action, status_id, errors, warnings, merge_status FROM public.import_70_01_01_lu_status_errors_data ORDER BY row_id;
...
SELECT row_id, state, action, valid_from, valid_to, errors, warnings, merge_status FROM public.import_70_01_02_es_invalid_data ORDER BY row_id;
...
SELECT row_id, state, action, valid_from, valid_to, errors, warnings, merge_status FROM public.import_70_01_03_es_inf_invalid_data ORDER BY row_id;
ROLLBACK TO scenario_70_1_warnings;
...
SELECT row_id, state, action, valid_from, valid_to, errors, warnings, merge_status FROM public.import_70_02_01_lu_missing_data ORDER BY row_id;
...
SELECT row_id, state, action, valid_from, valid_to, errors, warnings, merge_status FROM public.import_70_02_02_es_missing_link_data ORDER BY row_id;
...
SELECT row_id, state, action, valid_from, valid_to, errors, warnings, merge_status FROM public.import_70_03_01_es_bad_lu_link_data ORDER BY row_id;
...
SELECT row_id, state, action, valid_from, valid_to, errors, warnings, merge_status FROM public.import_70_06_01_lu_empty_name_data ORDER BY row_id;
...
SELECT row_id, name_raw as name, state, action, operation, errors, warnings, merge_status, legal_unit_id FROM public.import_70_07_01_lu_idents_data ORDER BY row_id;
...
SELECT row_id, name_raw as name, state, action, operation, errors, warnings, merge_status, establishment_id FROM public.import_70_07_02_est_f_idents_data ORDER BY row_id;
...
SELECT row_id, name_raw as name, state, action, operation, errors, warnings, merge_status, establishment_id FROM public.import_70_07_03_est_inf_idents_data ORDER BY row_id;
...
SELECT row_id, name_raw as name, state, action, errors, warnings, merge_status, legal_unit_id FROM public.import_70_08_link_est_lu_data ORDER BY row_id;
