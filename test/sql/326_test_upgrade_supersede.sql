...
INSERT INTO public.upgrade (commit_sha, committed_at, topological_order, release_status, state, summary, completed_at)
VALUES (lpad(to_hex(110), 40, '0'), now(), 110, 'commit', 'completed',
        'newer plain commit (dev.sh fix)', now());
...
VALUES (lpad(to_hex(120), 40, '0'), now(), 120, 'prerelease', 'completed',
        'rc.31 prerelease', ARRAY['v2026.04.0-rc.31'], now());
