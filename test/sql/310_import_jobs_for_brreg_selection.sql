...
SELECT state, count(*) FROM public.import_hovedenhet_2025_selection_data GROUP BY state;
SELECT state, count(*) FROM public.import_underenhet_2025_selection_data GROUP BY state;
