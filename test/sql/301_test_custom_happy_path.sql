...
BEGIN
    ...
    VALUES (v_definition_id, 'import_71_a1_lu', 'Test 71.A.1: LU-71A Initial', 'Test 71.A.1', false);
END $$;
...
BEGIN
    SELECT id INTO v_definition_id FROM public.import_definition WHERE slug = 'legal_unit_custom_test71';
    INSERT INTO public.import_job (definition_id, slug, description, edit_comment, review)
    VALUES (v_definition_id, 'import_71_a2_lu', 'Test 71.A.2: LU-71A Update 1', 'Test 71.A.2', false);
END $$;
...
BEGIN
    SELECT id INTO v_definition_id FROM public.import_definition WHERE slug = 'legal_unit_custom_test71';
    INSERT INTO public.import_job (definition_id, slug, description, edit_comment, review)
    VALUES (v_definition_id, 'import_71_b_lu_for_es', 'Test 71.B: Base LU for Formal ES', 'Test 71.B', false);
END $$;
...
BEGIN
    ...
    INSERT INTO public.import_job (definition_id, slug, description, edit_comment, review)
    VALUES (v_definition_id, 'import_71_b1_es', 'Test 71.B.1: ES-71B Initial', 'Test 71.B.1', false);
END $$;
...
BEGIN
    ...
    INSERT INTO public.import_job (definition_id, slug, description, edit_comment, review)
    VALUES (v_definition_id, 'import_71_c1_es', 'Test 71.C.1: ES-71C Initial', 'Test 71.C.1', false);
END $$;
...
BEGIN
    ...
    IF v_definition_id IS NULL THEN RAISE EXCEPTION 'Import definition legal_unit_custom_test71 not found.'; END IF;
    INSERT INTO public.import_job (definition_id, slug, description, edit_comment, review)
    VALUES (v_definition_id, 'import_71_d_null_handling', 'Test 71.D: Null value handling', 'Test import_as_null', false);
END $$;
