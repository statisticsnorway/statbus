```sql
CREATE OR REPLACE FUNCTION public.set_primary_legal_unit_for_enterprise(legal_unit_id integer, valid_from_param date DEFAULT CURRENT_DATE, valid_to_param date DEFAULT 'infinity'::date)
 RETURNS jsonb
 LANGUAGE plpgsql
AS $function$
DECLARE
