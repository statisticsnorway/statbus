```sql
CREATE OR REPLACE FUNCTION public.set_primary_establishment_for_legal_unit(establishment_id integer, valid_from_param date DEFAULT CURRENT_DATE, valid_to_param date DEFAULT 'infinity'::date)
 RETURNS jsonb
 LANGUAGE plpgsql
AS $function$
DECLARE
