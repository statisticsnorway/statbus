```sql
CREATE OR REPLACE FUNCTION public.statistical_unit_facet_drilldown(unit_type statistical_unit_type DEFAULT 'enterprise'::statistical_unit_type, region_path ltree DEFAULT NULL::ltree, activity_category_path ltree DEFAULT NULL::ltree, sector_path ltree DEFAULT NULL::ltree, legal_form_id integer DEFAULT NULL::integer, country_id integer DEFAULT NULL::integer, valid_on date DEFAULT CURRENT_DATE)
 RETURNS jsonb
 LANGUAGE sql
 SECURITY DEFINER
AS $function$
