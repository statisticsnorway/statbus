```sql
CREATE OR REPLACE FUNCTION admin.process_linked_legal_unit_external_idents(new_jsonb jsonb, OUT legal_unit_id integer, OUT linked_ident_specified boolean)
 RETURNS record
 LANGUAGE plpgsql
AS $function$
DECLARE
