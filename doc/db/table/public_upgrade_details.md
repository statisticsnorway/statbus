...
--------------------------+--------------------------+-----------+----------+-------------------------------+----------+-------------+--------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 progress_log             | text                     |           |          |                               | extended |             |              | DEPRECATED 2026-04-15 (#17): superseded by log_relative_file_path + tmp/upgrade-logs/. New rows no longer populate this column; it will be dropped in a later Wave 5 commit after the admin UI switches to file-backed log fetches.
