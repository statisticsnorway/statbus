...
----------------------------+----------------------------+-----------+----------+----------------------------------------+----------+-------------+--------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 claim_token                | uuid                       |           |          |                                        | plain    |             |              | Unique daemon claim identifier used to CAS terminal writes for an in_progress upgrade.
Indexes:
...
Check constraints:
    ...
    "chk_upgrade_rollback_finish_pending_requires_failed" CHECK (rollback_finish_pending_at IS NULL OR state = 'failed'::upgrade_state)
