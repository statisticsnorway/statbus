...
---------------------+--------------------------+-----------+----------+----------------------------------+----------+-------------+--------------+-------------
 ...
 shape               | external_ident_shape     |           | not null |                                  | plain    |             |              | 
 ident               | character varying(50)    |           |          |                                  | extended |             |              | 
 idents              | ltree                    |           |          |                                  | extended |             |              | 
...
Not-null constraints:
    "external_ident_id_not_null" NOT NULL "id"
    "external_ident_type_id_not_null1" NOT NULL "type_id"
    "external_ident_shape_not_null" NOT NULL "shape"
    "external_ident_edit_by_user_id_not_null" NOT NULL "edit_by_user_id"
    "external_ident_edit_at_not_null" NOT NULL "edit_at"
Triggers:
