...
---------------------+--------------------------+-----------+----------+------------------------------+----------+-------------+--------------+-------------
 ...
 user_start_period   | timestamp with time zone |           | not null |                              | plain    |             |              | 
 user_end_period     | timestamp with time zone |           | not null |                              | plain    |             |              | 
 user_id             | integer                  |           | not null |                              | plain    |             |              | 
 comment             | text                     |           |          |                              | extended |             |              | 
 server_start_period | timestamp with time zone |           |          |                              | plain    |             |              | 
 server_end_period   | timestamp with time zone |           |          |                              | plain    |             |              | 
Indexes:
