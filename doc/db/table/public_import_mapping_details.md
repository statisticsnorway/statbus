...
----------------------------+----------------------------+-----------+----------+--------------------------------------------+----------+-------------+--------------+--------------------------------------------------------------------------
 ...
 target_data_column_id      | integer                    |           |          |                                            | plain    |             |              | The target column in the _data table.
 target_data_column_purpose | import_data_column_purpose |           | not null | 'source_input'::import_data_column_purpose | plain    |             |              | The required purpose of the target data column (must be 'source_input').
