```sql
                                                        Table "public.timeline_power_group"
...
Indexes:
    "timeline_power_group_pkey" PRIMARY KEY, btree (unit_type, unit_id, valid_from)
    "idx_timeline_power_group_id" btree (power_group_id)
    "idx_timeline_power_group_valid" btree (valid_from, valid_until)
Policies:
    POLICY "timeline_power_group_admin_user_manage"
      TO admin_user
      USING (true)
      WITH CHECK (true)
    POLICY "timeline_power_group_authenticated_read" FOR SELECT
      TO authenticated
      USING (true)
    POLICY "timeline_power_group_regular_user_read" FOR SELECT
      TO regular_user
      USING (true)
Not-null constraints:
    "timeline_power_group_unit_type_not_null" NOT NULL "unit_type"
    "timeline_power_group_unit_id_not_null" NOT NULL "unit_id"
    "timeline_power_group_valid_from_not_null" NOT NULL "valid_from"
    "timeline_power_group_valid_until_not_null" NOT NULL "valid_until"
Access method: heap
