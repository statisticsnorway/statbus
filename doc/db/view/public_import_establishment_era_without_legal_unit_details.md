```sql
                     View "public.import_establishment_era_without_legal_unit"
...
View definition:
 SELECT import_establishment_era.valid_from,
    import_establishment_era.valid_to,
    import_establishment_era.tax_ident,
    ...
    import_establishment_era.physical_postal_code,
    import_establishment_era.physical_postal_place,
    ...
    import_establishment_era.postal_postal_code,
    import_establishment_era.postal_postal_place,
...
Triggers:
    import_establishment_era_without_legal_unit_upsert_trigger INSTEAD OF INSERT ON import_establishment_era_without_legal_unit FOR EACH ROW EXECUTE FUNCTION admin.import_establishment_era_without_legal_unit_upsert()
