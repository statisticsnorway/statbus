```sql
                              View "public.import_establishment_era"
...
View definition:
 SELECT ''::text AS valid_from,
    ...
    ''::text AS tag_path;
Triggers:
    import_establishment_era_upsert_trigger INSTEAD OF INSERT ON import_establishment_era FOR EACH ROW EXECUTE FUNCTION admin.import_establishment_era_upsert()
