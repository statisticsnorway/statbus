...
- `upgrade(id, backup_path, log_relative_file_path, committed_at, discovered_at, scheduled_at, started_at, completed_at, rolled_back_at, skipped_at, superseded_at, dismissed_at, commit_sha, commit_tags, release_status, summary, changes, release_url, has_migrations, error, from_commit_version, docker_images_downloaded, state, commit_version, docker_images_status, release_builds_status)` — **infrastructure**
