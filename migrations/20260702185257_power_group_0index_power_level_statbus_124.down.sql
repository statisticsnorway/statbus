-- STATBUS-124 DOWN: restore 1-based power_level substrate (verbatim pre-change defs)
BEGIN;
...
-- Reverse the stored-level re-base (uniform +1) to restore 1-based children.
...
-- STATBUS-124 missed ripple (root selectors): restore power_level = 1
