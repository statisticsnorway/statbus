...
-- Add info column for handler output (separate from payload which is input)
ALTER TABLE worker.tasks ADD COLUMN info JSONB;

-- Recreate view to include info column
...
-- Update collect_changes to write affected counts to info
