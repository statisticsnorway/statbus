...
-- Revert derive_statistical_unit: write counts back to payload instead of info
...
ALTER PROCEDURE worker.command_import_job(jsonb) SECURITY DEFINER;
ALTER PROCEDURE worker.command_import_job_cleanup(jsonb) SECURITY DEFINER;
ALTER PROCEDURE worker.command_task_cleanup(jsonb) SECURITY DEFINER;
