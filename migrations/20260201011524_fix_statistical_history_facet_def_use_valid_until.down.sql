-- Down Migration: Restore original statistical_history_facet_def with valid_to (buggy version)
-- This restores the function that uses valid_to instead of valid_until, which prevents index usage.
