-- Down Migration 20260324144302: optimize_filtered_get_closed_group_batches
-- Restore the original function that uses join-then-filter for both filtered and full modes.
BEGIN;
