...
CREATE UNIQUE INDEX ix_power_group_type_code ON public.power_group_type USING btree (code) WHERE active;
CREATE INDEX ix_power_group_type_active ON public.power_group_type USING btree (active);
