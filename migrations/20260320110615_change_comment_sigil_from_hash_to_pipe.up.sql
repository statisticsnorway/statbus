...
-- Change the separator in XLSX dropdown values from ' # ' to ' | '
-- Rationale: pipe looks like a drawn line separating two things,
-- while # can be confused with other sigils.
