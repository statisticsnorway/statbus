-- Down Migration 20260319170725: worker_info_own_contribution_principle
-- Restore all functions/procedures to their pre-migration state
BEGIN;

-- Restore derive_statistical_unit function (affected_* keys, not effective_*)
...
-- Restore import_job_process (cumulative snapshot)
...
-- Restore is_deriving_* functions to read affected_* from payload (pre-info-column version)
