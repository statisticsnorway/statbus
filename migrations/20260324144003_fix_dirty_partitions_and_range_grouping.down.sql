-- Down Migration 20260324144003: fix_dirty_partitions_and_range_grouping
-- Restore original functions with dirty_partitions TRUNCATE in su_facet_reduce
-- and range-based spawning for all refresh modes.
BEGIN;
