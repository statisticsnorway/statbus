-- Down Migration 20260203135656: optimize_statistical_history_facet_def_composite_key
--
-- Restore the previous version that used IS NOT DISTINCT FROM for facet matching
-- (before composite key optimization)
