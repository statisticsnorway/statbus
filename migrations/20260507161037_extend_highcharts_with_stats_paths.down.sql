-- Down Migration 20260507161037: extend highcharts with stats paths
--
-- Restore the prior public.statistical_history_highcharts function from
-- migration 20260327152214_add_stats_summary_to_highcharts (verbatim).
BEGIN;
