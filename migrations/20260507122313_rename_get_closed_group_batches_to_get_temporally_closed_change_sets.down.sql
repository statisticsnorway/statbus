-- Down migration 20260507122313: restore get_closed_group_batches and revert caller.

BEGIN;

----------------------------------------------------------------------
-- 1. Restore the original caller body in worker.derive_statistical_unit
----------------------------------------------------------------------
...
----------------------------------------------------------------------
-- 2. Restore the original function body under the old name
----------------------------------------------------------------------
...
----------------------------------------------------------------------
-- 3. Drop the new function name (the up migration's caller no longer
--    exists, so nothing references it after step 1)
----------------------------------------------------------------------

DROP FUNCTION public.get_temporally_closed_change_sets(integer, int4multirange, int4multirange, int4multirange, integer, integer);
