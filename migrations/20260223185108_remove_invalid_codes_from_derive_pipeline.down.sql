...
-- =============================================================================
-- Down Migration: Restore invalid_codes to the derive pipeline
-- =============================================================================

-- Step 1: Drop modified views and functions
...
-- Step 2: Drop sql_saga views (they need to be regenerated with the restored column)
...
ALTER TABLE public.establishment ADD COLUMN IF NOT EXISTS invalid_codes JSONB;
ALTER TABLE public.legal_unit ADD COLUMN IF NOT EXISTS invalid_codes JSONB;
ALTER TABLE public.timeline_establishment ADD COLUMN IF NOT EXISTS invalid_codes JSONB;
ALTER TABLE public.timeline_legal_unit ADD COLUMN IF NOT EXISTS invalid_codes JSONB;
ALTER TABLE public.timeline_enterprise ADD COLUMN IF NOT EXISTS invalid_codes JSONB;
ALTER TABLE public.statistical_unit ADD COLUMN IF NOT EXISTS invalid_codes JSONB;
ALTER TABLE public.statistical_unit_staging ADD COLUMN IF NOT EXISTS invalid_codes JSONB;

-- Step 4: Recreate sql_saga views (now with invalid_codes column)
...
-- Step 6: Recreate original views (with invalid_codes)

-- timeline_establishment_def (original)
...
-- timeline_legal_unit_def (original)
...
-- timeline_enterprise_def (original)
...
-- Step 7: Recreate original functions

-- relevant_statistical_units (original)
...
AS $function$
    ...
    SELECT unit_type
         ...
         -- invalid_codes moved to end: ALTER TABLE ADD COLUMN puts it at end of table type
         , invalid_codes
    FROM ordered_units;
$function$
;

-- get_statistical_unit_data_partial (original)
...
-- statistical_unit_refresh (original)
...
-- create_statistical_unit_ui_indices (original)
...
-- process_establishment (original)
...
-- Step 7b: Restore timeline_enterprise_refresh with invalid_codes
-- Step 7c: Restore statistical_unit_flush_staging with invalid_codes
