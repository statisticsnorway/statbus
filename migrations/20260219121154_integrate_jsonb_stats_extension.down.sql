...
-- =============================================================================
-- Revert jsonb_stats Rust extension integration
-- Restores PL/pgSQL functions and original view definitions
-- =============================================================================

-- 1. Recreate old PL/pgSQL functions
...
-- 2. Restore original views and functions

-- Restore timeline_establishment_def
...
-- Restore timeline_legal_unit_def
...
-- Restore timeline_enterprise_def
...
-- Restore timeline_enterprise_refresh
...
-- Restore statistical_history_def
...
-- Restore statistical_history_facet_def
...
-- Restore statistical_unit_facet_drilldown
...
-- Restore statistical_history_drilldown
...
-- Restore statistical_unit_facet_def
...
-- Restore worker.derive_statistical_unit_facet_partition (with old function name)
...
-- Restore worker.statistical_unit_facet_reduce (with old function name)
...
-- Restore worker.statistical_history_facet_reduce (with old function name)
...
-- Restore worker.statistical_history_reduce (with old function name)
...
-- 4. Drop the jsonb_stats extension
DROP EXTENSION IF EXISTS jsonb_stats;
