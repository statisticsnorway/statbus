...
CREATE INDEX ix_location_legal_unit_id_valid_range ON public.location USING gist (legal_unit_id, valid_range);
CREATE INDEX ix_location_establishment_id_valid_range ON public.location USING gist (establishment_id, valid_range);
CREATE INDEX ix_location_valid_range ON public.location USING gist (valid_range);
...
CREATE INDEX ON location (establishment_id, legal_unit_id, type);
...
SELECT sql_saga.add_era('public.location', 'valid_range', 'valid', ephemeral_columns => ARRAY['edit_comment', 'edit_by_user_id', 'edit_at']);
