...
CREATE TABLE public.legal_relationship (
    ...
    derived_power_group_id integer REFERENCES public.power_group(id) ON DELETE SET NULL,
    derived_influenced_power_level integer,  -- BFS depth: 2 = direct child, 3 = grandchild, etc.
...
-- data quality issues. The power group derivation handles cycles via
