-- Down Migration 20260319221604: info_localize_reporting
BEGIN;

-- Restore admin.import_job_process to pre-localization state
...
-- Restore worker.derive_reports_phase (no info reporting)
...
-- Restore worker.statistical_unit_flush_staging (no info reporting)
