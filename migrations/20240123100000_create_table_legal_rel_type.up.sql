...
CREATE UNIQUE INDEX ix_legal_rel_type_code ON public.legal_rel_type USING btree (code) WHERE active;
CREATE INDEX ix_legal_rel_type_active ON public.legal_rel_type USING btree (active);
