...
INSERT INTO public.import_step (code, name, priority, analyse_procedure, process_procedure, is_holistic) VALUES
    ...
    ('data_source',                      'Data Source Resolution',     16, 'import.analyse_data_source'::regproc, NULL, false),
...
WITH ordered_values AS (
    ...
    FROM (
        ...
        -- The resolved legal_unit_id and establishment_id are owned by the external_idents step.
        -- This is critical for generic "update-only" jobs (e.g., updating stats for existing units)
        -- which might only include the external_idents step and a sub-entity step (like statistical_variables),
        -- without including the full legal_unit or establishment steps. This ownership ensures that the
        -- resolved IDs are always available in the _data table after identifiers have been analyzed.
        ('external_idents', 'legal_unit_id', 'INTEGER', 'pk_id', true, NULL, false),
        ('external_idents', 'establishment_id', 'INTEGER', 'pk_id', true, NULL, false),
        ...
        ('data_source', 'data_source_code_raw',      'TEXT', 'source_input', true, NULL, false),
        ('data_source', 'data_source_id',        'INTEGER', 'internal', true, NULL, false),
        ('valid_time', 'valid_from_raw',            'TEXT', 'source_input', true, NULL, false),
        ('valid_time', 'valid_to_raw',              'TEXT', 'source_input', true, NULL, false),
        ('valid_time', 'valid_from',            'DATE', 'internal',     true, NULL, false),
        ('valid_time', 'valid_to',              'DATE', 'internal',     true, NULL, false),
        ('valid_time', 'valid_until',           'DATE', 'internal',     true, NULL, false),
        ('status', 'status_code_raw',                'TEXT',    'source_input', true, NULL, false),
        ('status', 'status_id',                  'INTEGER', 'internal',     true, NULL, false),
        ('legal_unit', 'name_raw',                       'TEXT',    'source_input', true, NULL, false),
        ('legal_unit', 'name',                           'TEXT',    'internal',     true, NULL, false),
        ('legal_unit', 'birth_date_raw',                 'TEXT',    'source_input', true, NULL, false),
        ('legal_unit', 'death_date_raw',                 'TEXT',    'source_input', true, NULL, false),
        ('legal_unit', 'sector_code_raw',                'TEXT',    'source_input', true, NULL, false),
        ('legal_unit', 'unit_size_code_raw',             'TEXT',    'source_input', true, NULL, false),
        ('legal_unit', 'legal_form_code_raw',            'TEXT',    'source_input', true, NULL, false),
        ...
        ('legal_unit', 'birth_date',                     'DATE',    'internal',     true, NULL, false),
        ('legal_unit', 'death_date',                     'DATE',    'internal',     true, NULL, false),
        ('establishment', 'name_raw',                       'TEXT',    'source_input', true, NULL, false),
        ('establishment', 'name',                           'TEXT',    'internal',     true, NULL, false),
        ('establishment', 'birth_date_raw',                 'TEXT',    'source_input', true, NULL, false),
        ('establishment', 'death_date_raw',                 'TEXT',    'source_input', true, NULL, false),
        ('establishment', 'sector_code_raw',                'TEXT',    'source_input', true, NULL, false),
        ('establishment', 'unit_size_code_raw',             'TEXT',    'source_input', true, NULL, false),
        ('establishment', 'sector_id',                      'INTEGER', 'internal',     true, NULL, false),
        ('establishment', 'unit_size_id',                   'INTEGER', 'internal',     true, NULL, false),
        ('establishment', 'birth_date',                     'DATE',    'internal',     true, NULL, false),
        ('establishment', 'death_date',                     'DATE',    'internal',     true, NULL, false),
        ('physical_location', 'physical_address_part1_raw',  'TEXT',    'source_input', true, NULL, false),
        ('physical_location', 'physical_address_part1',      'TEXT',    'internal',     true, NULL, false),
        ('physical_location', 'physical_address_part2_raw',  'TEXT',    'source_input', true, NULL, false),
        ('physical_location', 'physical_address_part2',      'TEXT',    'internal',     true, NULL, false),
        ('physical_location', 'physical_address_part3_raw',  'TEXT',    'source_input', true, NULL, false),
        ('physical_location', 'physical_address_part3',      'TEXT',    'internal',     true, NULL, false),
        ('physical_location', 'physical_postcode_raw',       'TEXT',    'source_input', true, NULL, false),
        ('physical_location', 'physical_postcode',           'TEXT',    'internal',     true, NULL, false),
        ('physical_location', 'physical_postplace_raw',      'TEXT',    'source_input', true, NULL, false),
        ('physical_location', 'physical_postplace',          'TEXT',    'internal',     true, NULL, false),
        ('physical_location', 'physical_latitude_raw',       'TEXT',    'source_input', true, NULL, false),
        ('physical_location', 'physical_longitude_raw',      'TEXT',    'source_input', true, NULL, false),
        ('physical_location', 'physical_altitude_raw',       'TEXT',    'source_input', true, NULL, false),
        ('physical_location', 'physical_region_code_raw',    'TEXT',    'source_input', true, NULL, false),
        ('physical_location', 'physical_country_iso_2_raw',  'TEXT',    'source_input', true, NULL, false),
        ...
        ('physical_location', 'physical_latitude',           'numeric(9,6)', 'internal', true, NULL, false),
        ('physical_location', 'physical_longitude',          'numeric(9,6)', 'internal', true, NULL, false),
        ('physical_location', 'physical_altitude',           'numeric(6,1)', 'internal', true, NULL, false),
        ('postal_location',   'postal_address_part1_raw',    'TEXT',    'source_input', true, NULL, false),
        ('postal_location',   'postal_address_part1',        'TEXT',    'internal',     true, NULL, false),
        ('postal_location',   'postal_address_part2_raw',    'TEXT',    'source_input', true, NULL, false),
        ('postal_location',   'postal_address_part2',        'TEXT',    'internal',     true, NULL, false),
        ('postal_location',   'postal_address_part3_raw',    'TEXT',    'source_input', true, NULL, false),
        ('postal_location',   'postal_address_part3',        'TEXT',    'internal',     true, NULL, false),
        ('postal_location',   'postal_postcode_raw',         'TEXT',    'source_input', true, NULL, false),
        ('postal_location',   'postal_postcode',             'TEXT',    'internal',     true, NULL, false),
        ('postal_location',   'postal_postplace_raw',        'TEXT',    'source_input', true, NULL, false),
        ('postal_location',   'postal_postplace',            'TEXT',    'internal',     true, NULL, false),
        ('postal_location',   'postal_region_code_raw',      'TEXT',    'source_input', true, NULL, false),
        ('postal_location',   'postal_country_iso_2_raw',    'TEXT',    'source_input', true, NULL, false),
        ('postal_location',   'postal_latitude_raw',         'TEXT',    'source_input', true, NULL, false),
        ('postal_location',   'postal_longitude_raw',        'TEXT',    'source_input', true, NULL, false),
        ('postal_location',   'postal_altitude_raw',         'TEXT',    'source_input', true, NULL, false),
        ...
        ('postal_location',   'postal_latitude',             'numeric(9,6)', 'internal', true, NULL, false),
        ('postal_location',   'postal_longitude',            'numeric(9,6)', 'internal', true, NULL, false),
        ('postal_location',   'postal_altitude',             'numeric(6,1)', 'internal', true, NULL, false),
        ('primary_activity',  'primary_activity_category_code_raw', 'TEXT', 'source_input', true, NULL, false),
        ...
        ('secondary_activity','secondary_activity_category_code_raw', 'TEXT', 'source_input', true, NULL, false),
        ...
        ('contact',      'web_address_raw',             'TEXT',    'source_input', true, NULL, false),
        ('contact',      'web_address',                 'TEXT',    'internal',     true, NULL, false),
        ('contact',      'email_address_raw',           'TEXT',    'source_input', true, NULL, false),
        ('contact',      'email_address',               'TEXT',    'internal',     true, NULL, false),
        ('contact',      'phone_number_raw',            'TEXT',    'source_input', true, NULL, false),
        ('contact',      'phone_number',                'TEXT',    'internal',     true, NULL, false),
        ('contact',      'landline_raw',                'TEXT',    'source_input', true, NULL, false),
        ('contact',      'landline',                    'TEXT',    'internal',     true, NULL, false),
        ('contact',      'mobile_number_raw',           'TEXT',    'source_input', true, NULL, false),
        ('contact',      'mobile_number',               'TEXT',    'internal',     true, NULL, false),
        ('contact',      'fax_number_raw',              'TEXT',    'source_input', true, NULL, false),
        ('contact',      'fax_number',                  'TEXT',    'internal',     true, NULL, false),
        ('contact',      'contact_id',                  'INTEGER', 'pk_id',        true, NULL, false),
        ('tags',             'tag_path_raw',                'TEXT',    'source_input', true, NULL, false),
        ('tags',             'tag_path',                    'public.LTREE', 'internal', true, NULL, false),
        ('tags',             'tag_id',                      'INTEGER', 'internal',     true, NULL, false),
        ('tags',             'tag_for_unit_id',             'INTEGER', 'pk_id',        true, NULL, false),
        ('edit_info',         'edit_comment_raw',            'TEXT',      'source_input', true, NULL, false),
