-- Down Migration 20260206211707: fix_derive_pipeline_consistency
-- Restores the original behavior where batches DELETE from main table immediately.
BEGIN;

-- =============================================================================
-- 1. Restore statistical_unit_refresh: re-add DELETE from main table in partial mode
-- =============================================================================
...
-- =============================================================================
-- 2. Restore statistical_unit_flush_staging: drop/recreate indices, no DELETE from main
-- =============================================================================
...
-- =============================================================================
-- 3. Restore derive_statistical_unit: remove staging TRUNCATE at start
-- =============================================================================
