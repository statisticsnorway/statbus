-- Down Migration 20260324224225: incremental_timesegments_years_maintenance
-- Restore per-batch timesegments_years_refresh_concurrent call.
BEGIN;

-- Restore timesegments_refresh without incremental year recording
...
-- Restore statistical_unit_refresh_batch with per-batch timesegments_years call
...
-- Restore flush_staging without year cleanup
