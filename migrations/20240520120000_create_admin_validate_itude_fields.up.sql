CREATE FUNCTION admin.validate_itude_fields(location_type public.location_type, new_jsonb jsonb)
RETURNS TABLE (
    latitude numeric(9,6),
    longitude numeric(9,6),
    altitude numeric(6,1)
) LANGUAGE plpgsql AS $validate_itude_fields$
DECLARE
