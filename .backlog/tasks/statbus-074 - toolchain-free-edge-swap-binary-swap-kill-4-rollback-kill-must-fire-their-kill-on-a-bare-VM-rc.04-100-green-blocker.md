...
DONE (foreman-verified 2026-06-19): the 4 no-compiler kill arcs (preswap-backup-kill, preswap-binary-swap-kill, preswap-checkout-kill, rollback-kill) are reshaped + GREEN on bare Hetzner VMs per the §9(5) 5b CAT-A milestone (5/5 kill-arcs green); they procure the sb binary via install_statbus_at_sha (Docker image), no host Go toolchain.
<!-- SECTION:NOTES:END -->
