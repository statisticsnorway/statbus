...
- [ ] #10 `new: test/install-recovery/evidence/STATBUS-376-third-party-ubuntu-26-04-1.md` records the candidate tag, VM architecture, Ubuntu image, D1-D7 test results, service states, HTTPS result, and operator transcript for the named run `STATBUS-376-third-party-ubuntu-26-04-1`.
<!-- AC:END -->
