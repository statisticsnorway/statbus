...
BEGIN
    ...
    VALUES ('brreg_hovedenhet_2024', 'Import of BRREG Hovedenhet using 2024 columns', 'Easy upload of the CSV file found at brreg.', 'insert_or_replace', 'legal_unit', false, (SELECT id FROM public.data_source WHERE code = 'brreg'))
