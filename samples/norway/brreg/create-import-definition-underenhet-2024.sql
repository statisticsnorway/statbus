...
DECLARE
    ...
    es_steps TEXT[] := ARRAY[
        'external_idents', 'link_establishment_to_legal_unit', 'valid_time_from_source', 'establishment',
...
BEGIN
    ...
    VALUES ('brreg_underenhet_2024', 'Import of BRREG Underenhet using 2024 columns', 'Easy upload of the CSV file found at brreg.', 'upsert', false)
    RETURNING id INTO def_id;

    -- 2. Link the required steps to the definition
    PERFORM admin.link_steps_to_definition(def_id, es_steps);
