...
namespace nscreg.Data.Entities
{
    public abstract class StatisticalUnit : IStatisticalUnit
    {
        ...
        [Display(Order = 200, GroupName = nameof(GroupName.StatUnitInfo))]
        ...
        [Display(Order = 120, GroupName = nameof(GroupName.StatUnitInfo))]
        public string Name { get; set; } //	Full name of Unit

        [Display(Order = 130, GroupName = nameof(GroupName.StatUnitInfo))]
        ...
        [Display(Order = 250, GroupName = nameof(GroupName.ContactInfo))]
        public virtual Address Address { get; set; }

        [Display(Order = 280, GroupName = nameof(GroupName.ContactInfo))]
        public int PostalAddressId { get; set; } //	Id of postal address (post box or similar, if relevant)

        [Display(Order = 290, GroupName = nameof(GroupName.ContactInfo))]
        public string TelephoneNo { get; set; } //

        [Display(Order = 300, GroupName = nameof(GroupName.ContactInfo))]
        public string EmailAddress { get; set; } //

        [Display(Order = 270, GroupName = nameof(GroupName.ContactInfo))]
        public string WebAddress { get; set; } //

        [Display(Order = 240, GroupName = nameof(GroupName.RegistrationInfo))]
        ...
        [Display(Order = 230, GroupName = nameof(GroupName.RegistrationInfo))]
        ...
        //[NotMappedFor(ActionsEnum.View)]
        [Display(Order = 310, GroupName = nameof(GroupName.ContactInfo))]
        public virtual Address ActualAddress { get; set; }

        [Display(Order = 260, GroupName = nameof(GroupName.ContactInfo))]
        public string ContactPerson { get; set; } //

        [Display(Order = 500, GroupName = nameof(GroupName.IndexInfo))]
        ...
        [Display(Order = 540, GroupName = nameof(GroupName.IndexInfo))]
        public decimal Turnover { get; set; } //

        [Display(Order = 560, GroupName = nameof(GroupName.IndexInfo))]
        public DateTime TurnoverYear { get; set; } //	Year of which the turnover is/was valid

        [Display(Order = 550, GroupName = nameof(GroupName.IndexInfo))]
        ...
        [Display(Order = 600, GroupName = nameof(GroupName.IndexInfo))]
        public DateTime StatusDate { get; set; } //

        [Display(Order = 570, GroupName = nameof(GroupName.IndexInfo))]
        public string Notes { get; set; } //

        [Display(Order = 470, GroupName = nameof(GroupName.IndexInfo))]
        public bool FreeEconZone { get; set; }

        //	Yes/no (whether the unit operates in a Free economic zone with different tax rules)

        [Display(Order = 460, GroupName = nameof(GroupName.IndexInfo))]
        ...
        [Display(Order = 580, GroupName = nameof(GroupName.IndexInfo))]
        ...
        //TODO: USE VIEW MODEL
        [Display(Order = 650, GroupName = nameof(GroupName.RegistrationInfo))]
        [NotMapped]
