    ...
    Tables: {
      ...
      upgrade: {
        Row: {
          ...
          error: string | null;
          failure_code:
            | Database["public"]["Enums"]["upgrade_failure_code"]
            | null;
      ...
      upgrade_state_log: {
        Row: {
          actor: string | null;
          actor_source:
            | Database["public"]["Enums"]["upgrade_actor_source"]
            | null;
    ...
    Views: {
      ...
      activity_category_standard_enabled: {
        Row: {
          code: string | null;
          code_pattern:
            | Database["public"]["Enums"]["activity_category_code_behaviour"]
            | null;
          description: string | null;
      ...
      power_root__for_portion_of_valid: {
        Row: {
          ...
          derived_root_status:
            | Database["public"]["Enums"]["power_group_root_status"]
            | null;
          edit_at: string | null;
          edit_by_user_id: number | null;
          edit_comment: string | null;
