...
export type WorkerStatusPayload =
  ...
  | { type: 'pipeline_progress'; phases: Array<{ phase: string; step: string | null; total: number; completed: number; affected_establishment_count: number | null; affected_legal_unit_count: number | null; affected_enterprise_count: number | null; affected_power_group_count: number | null }> }
