...
export type WorkerStatusPayload =
  ...
  | { type: 'pipeline_progress'; phases: Array<{ phase: string; step: string | null; total: number; completed: number; effective_establishment_count: number | null; effective_legal_unit_count: number | null; effective_enterprise_count: number | null; effective_power_group_count: number | null }> }
