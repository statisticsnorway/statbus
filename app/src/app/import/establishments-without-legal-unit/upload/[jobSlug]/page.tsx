...
export default function EstablishmentsWithoutLegalUnitUploadPage({
  ...
  const { refreshJobs: refreshPendingJobs } = usePendingJobsByMode('establishment_informal');
  ...
  }, [jobSlug], 'UploadInformalEstablishmentsPage:loadJob');
  ...
  }, [job?.id], 'UploadInformalEstablishmentsPage:sseListener'); // Re-run effect if job.id changes
  ...
  if (error) {
    return (
      <div className="p-4 bg-red-50 border border-red-200 rounded-md text-red-700">
        Error: {error}. Please return to the <a href="/import/establishments-without-legal-unit" className="underline">upload page</a>.
      </div>
    );
  }
  ...
  if (!job) {
    return (
      <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-md text-yellow-800">
        ...
        Return to the <a href="/import/establishments-without-legal-unit" className="underline">upload page</a>.
      </div>
    );
  }
