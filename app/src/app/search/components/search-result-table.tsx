                    ...
                    statisticalUnits?.map((unit) => {
                            ...
                            return (
                                <TableRow key={`${unit_type}_${unit_id}`}>
                                    ...
                                    <TableCell
                                        className="text-left py-1">{getRegionByPath(physical_region_path)?.name}</TableCell>
                                    <TableCell
                                        className="text-right py-1 px-4">{getActivityCategoryByPath(primary_activity_category_path)?.code}</TableCell>
                                </TableRow>
                            )
                        }
                    )
