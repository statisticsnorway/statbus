    ...
    return <section className="space-y-8">
        ...
        <Accordion type="single" collapsible>
            <AccordionItem value="Activity Category Standard">
                <AccordionTrigger>What is an Activity Category Standard?</AccordionTrigger>
                <AccordionContent>
                    Activity category standards like NACE and ISIC organize economic activities into sectors for
                    systematic analysis.
                </AccordionContent>
            </AccordionItem>
            <AccordionItem value="NACE">
                ...
                <AccordionContent>
                    <strong>NACE</strong> (Statistical Classification of Economic Activities in the European Community)
                    is a standard
            ...
            <AccordionItem value="ISIC">
                ...
                <AccordionContent>
                    <strong>ISIC</strong> (International Standard Industrial Classification of All Economic Activities)
                    is a globally
                    accepted standard
