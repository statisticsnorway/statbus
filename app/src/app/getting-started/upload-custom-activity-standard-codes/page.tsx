        ...
        <section className="space-y-8">
            ...
            <Accordion type="single" collapsible>
                <AccordionItem value="Legal Unit">
                    <AccordionTrigger>What is a Custom Activity Category Code?</AccordionTrigger>
                    <AccordionContent>
                        <p className="mb-3">
                            A <i>Custom Activity Category Code</i> is a code that you can use to categorize economic
                            activities and units for statistical and analytical purposes. It is a category code
                            that is not part of the standard classification systems like NACE or ISIC and may be
                            specific to your country.
                        </p>
                    </AccordionContent>
                </AccordionItem>
                <AccordionItem value="Legal Units File">
                    <AccordionTrigger>What is a Custom Activity Categories file?</AccordionTrigger>
                    <AccordionContent>
                        <p className="mb-3">
                            A Custom Activity Categories file is a CSV file containing the Custom Activity Categories
                            you want to use in your
                            analysis. The file must conform to a specific format in order to be processed correctly.
