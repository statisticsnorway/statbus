...
// at-or-past-target deterministic release failure. PARK is the Layer 2
// anti-loop bound: automatic rollback plus channel re-offer would repeat the same
// failing release forever with nobody told. No write-loss hedge participates in
// this split; it routes a terminal outcome and never decides forward versus back.
