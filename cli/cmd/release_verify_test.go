...
// TestFindLatestStableTagBeforePrefix and TestPickPrereleasePredecessor moved
// to cli/internal/release/predecessor_test.go (STATBUS-329) alongside the
// functions they test, which moved to internal/release so
// cli/internal/migrate's migrate-down guard can reuse them without a second
// implementation of "is this migration released".
