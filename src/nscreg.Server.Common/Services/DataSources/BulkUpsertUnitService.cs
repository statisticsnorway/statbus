        ...
        public async Task CreateLegalWithEnterpriseAndLocal(LegalUnit legal)
        {
            ...
            using (var transaction = _dbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    //        createdEnterprise = await CreateEnterpriseForLegalAsync(legal);
                    ...
                    //    x.RegionId == legal.Address.RegionId &&
                    ...
                    //    x.Longitude == legal.Address.Longitude).ToList();
                    Tracer.address.Stop();
                    ...
                    //    createdLocal = await CreateLocalForLegalAsync(legal);
