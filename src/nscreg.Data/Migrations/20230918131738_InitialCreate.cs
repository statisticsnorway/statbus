        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Id_Date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserStartPeriod = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UserEndPeriod = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    Comment = table.Column<string>(type: "text", nullable: true),
                    ServerStartPeriod = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ServerEndPeriod = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GeneratedDateTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreationDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    EditingDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    IdDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    StartImportDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    EndImportDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RegId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    RegIdDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    StatId = table.Column<string>(type: "text", nullable: true),
                    StatIdDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    TaxRegDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ExternalId = table.Column<string>(type: "text", nullable: true),
                    ExternalIdType = table.Column<string>(type: "text", nullable: true),
                    ExternalIdDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    LiqDateStart = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LiqDateEnd = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    EmployeesDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Turnover = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    TurnoverYear = table.Column<int>(type: "integer", nullable: true),
                    TurnoverDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    ReorgDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LiqDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LiqReason = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    SuspensionStart = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    SuspensionEnd = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    EntGroupIdDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    EntRegIdDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    LegalUnitIdDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
